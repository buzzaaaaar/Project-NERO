        ...
        .then(data => {
            ...
            data.forEach(product => {
                ...
                <div class="col p-1">
                    ...
                    <div class="card-body myCustom-Shop-cardbody">
                        <h5 class="card-title px-1">${product.Product_Name}</i></h5>
                    ...
                    <div class="myCustom-Shop-rating-container">
                      <span><i class="bi bi-star myCustom-Shop-rating-stars"></i></span>
                      <span><i class="bi bi-star myCustom-Shop-rating-stars"></i></span>
                      <span><i class="bi bi-star myCustom-Shop-rating-stars"></i></span>
                      <span><i class="bi bi-star myCustom-Shop-rating-stars"></i></span>
                      <span><i class="bi bi-star myCustom-Shop-rating-stars"></i></span>
                      <span class="myCustom-Shop-original-price px-1">(48)</span>
                    </div>
                    </div>
                    <div class="card-footer row gx-0">
                    <div class="col-6">
                        <small class="text-body-secondary">${product.Free_Shipping === '1' ? 'Free Shipping' : ''}</small>
                    </div>
                    <div class="col-6 text-end">
                        ${product.Discount > 0 ? `
                            <span class="text-body-secondary mx-1 px-1 py-1 myCustom-Shop-item-offer" style="white-space: nowrap;">${product.Discount_Percentage}% OFF</span>                    
                            ` : `
